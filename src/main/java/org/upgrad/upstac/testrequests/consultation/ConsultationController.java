...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        //Commented this out: throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // replace this line of code with your implementation
        // Commented this out to replace the exception: throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        TestRequest request = testRequestUpdateService.assignForConsultation(153466l,user);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        User user = userLoggedInService.getLoggedInUser();
        TestRequest consultation = testRequestUpdateService.updateConsultation(5467787l,user,user);
        ...
        try {
            return testRequestUpdateService.updateConsultation(5467787l,user);
